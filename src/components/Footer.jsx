        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-sm text-brand-sandMuted max-w-md leading-relaxed">
              Onderscheidende websites op maat. Ik bouw eerst een gratis werkend voorbeeld om je enthousiast te maken en kom persoonlijk langs op locatie. Ben je enthousiast? Dan betaal je € 299,- en maken we de website tot in de puntjes compleet af.
            </p>
