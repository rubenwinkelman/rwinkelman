      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="max-w-3xl mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-brand-sandMuted leading-relaxed">
            Geen torenhoge offertes vooraf. Ik maak eerst een werkend voorbeeld om je enthousiast te maken en kom persoonlijk langs. Ben je enthousiast? Dan betaal je € 299,- en maken we de website tot in de puntjes compleet af.
          </p>
        </div>
          ...
          <div className="bg-brand-surface border border-white/10 rounded-2xl p-8 flex flex-col justify-between hover:border-white/20 transition-all duration-300 relative shadow-xl hover:-translate-y-1">
            <div>
              ...
              <div className="flex items-baseline gap-2 mb-2">
                <span className="text-5xl font-extrabold text-brand-sand">€ 299</span>
