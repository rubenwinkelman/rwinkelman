      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="pricing-header reveal-item max-w-3xl mb-16">
          ...
          <p className="mt-4 text-base sm:text-lg text-brand-sandMuted leading-relaxed">
            Wij maken eerst een professionele voorbeeldwebsite die volledig is afgestemd op jouw bedrijf. Bevalt het ontwerp? Dan bouwen we hem af voor <span className="whitespace-nowrap font-bold text-brand-sand">€&nbsp;699,-</span> en nemen we ook het onderhoud en de aanpassingen uit handen. Niet overtuigd van de website of onze aanpak? <span className="whitespace-nowrap text-emerald-400 font-semibold">No cure, no pay</span>. <span className="text-xs text-brand-sandDim block mt-1.5">Alle vermelde tarieven zijn exclusief 21% btw.</span>
          </p>
        </div>
