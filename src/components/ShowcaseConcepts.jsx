...
export default function ShowcaseConcepts() {
  ...
  return (
    <section ref={containerRef} id="showcase" className="py-24 md:py-32 bg-brand-dark relative border-t border-white/5 overflow-hidden isolate">
      {/* Subtle warm ambient breathing glow using pure CSS radial gradient (GPU Compositor, 0% CPU) */}
      <div className="anim-ambient-glow-1 showcase-glow absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] sm:w-[850px] h-[400px] bg-[radial-gradient(ellipse_at_center,_rgba(240,101,67,0.25)_0%,_rgba(240,101,67,0.06)_50%,_transparent_70%)] pointer-events-none z-0" />
